...
public class AddCandidate extends JFrame implements ActionListener{
	...
	JTextField tfname,tffname,tfaddress,tfphone,tfaadhar,tfemail,tmname,tfgender;
	JDateChooser dcdob;
	...
	AddCandidate(){
		...
		JLabel heading=new JLabel("Add Candidate Details");
		...
		String courses[]={"BBA","BCA","BA","B.COM","BSC","BTECH","MBA","MCA","MA","MTACH","MSC","PHD"};
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()== add) {
			...
			String candId=lblcandId.getText();
			try {
				conn conn=new conn();
				String query="insert into candidate values('"+name+"','"+fname+"','"+dob+"','"+mname+"','"+address+"','"+phone +"','"+email+"','"+education+"','"+gender+"','"+aadhar+"','"+candId+"')";
